...
public record AnalysisSubject(
        @JsonPropertyDescription("Company name, sector, or market segment to analyse")
        String subject,
        @JsonPropertyDescription("Geographic region of focus, e.g. US, EU, APAC, or Global")
        String region
) {
}
