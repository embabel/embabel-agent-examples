...
public record SwotEntry(
        @JsonPropertyDescription("One of: Strength, Weakness, Opportunity, Threat")
        String category,
        @JsonPropertyDescription("Concise description of this SWOT item")
        String description
) {
}
