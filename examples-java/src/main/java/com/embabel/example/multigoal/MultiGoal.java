 ...
 */
package com.embabel.example.multigoal;
...
class CodeResearchAgent {
    ...
    @AchievesGoal(description = "Examines a codebase, from GitHub or on disk, and reports on it")
    @Action
    public CodeResearchReport codeDeepDive(UserInput userInput) {
...
class Decker {
    ...
    @Action
    public Deck buildDeck(DeckRequest deckRequest, ResearchReport researchReport) {
